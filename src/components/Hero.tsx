      ...
      <div className="pl-6 m-0 flex flex-wrap py-16">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="w-full mb-8" style={{ marginTop: "100px" }}>
            <h1 className="text-white text-4xl font-bold leading-snug tracking-tight lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight">
            ...
            <div className="w-full mt-8">
              <Slider {...sliderSettings}>
                <div>
                  <h2 className="text-4xl font-semibold text-start text-[#3B71CA] underline">
                    Proyecte su demanda
                  </h2>
                </div>
                <div>
